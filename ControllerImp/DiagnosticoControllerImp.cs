...
using AutoMapper;
using Catalog.DTOs.DiagnosticoDTO;
...
namespace Catalog.Controllers
{
    ...
    {
        private readonly DiagnosticoService diagService;
        private readonly IMapper mapper;
        public DiagnosticoController(DiagnosticoService diagService, IMapper mapper)
        {
